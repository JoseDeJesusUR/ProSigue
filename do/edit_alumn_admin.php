...
<form action="edit_resp_alumn_admin.php" method="post">    
  ...
  <div>
    <table>
      ...
      <button class="button" style="vertical-align:middle" onclick="guardar(<?php echo $rs[$cont]['id'] ?>)"><span>Guardar</span></button>
</form>
...
<script>  
  function guardar(x){ 
		var flag = confirm("Esta seguro de que desea guardar?")
		if (flag){       
			window.location = "edit_resp_alumn_admin.php.php?idx="+x
